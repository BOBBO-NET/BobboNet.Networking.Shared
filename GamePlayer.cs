...
{
    public abstract class GamePlayer<UpdateDataType>
        where UpdateDataType : class, INetSerializable
    {
        //
        //  Variables
        //
        ...
        public abstract void ApplyPlayerUpdate(UpdateDataType newUpdate);
        ...
        public abstract UpdateDataType CommitToPlayerUpdate();

        // Creates a player update from the current player state.        
        public abstract UpdateDataType CreatePlayerUpdate();
    }
}